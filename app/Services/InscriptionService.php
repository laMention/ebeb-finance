    ...
    public function inscrire(array $data, array $fichiersKyc): User
    {
        ...
        return DB::transaction(function () use ($data, $fichiersKyc) {
            ...
            $user = User::create([
                ...
                'sexe' => mettre_en_majuscule($data['sexe'] ?? null) ?? '',
                'date_naissance' => $data['date_naissance'] ?? '',
                'email' => $data['email'] ?? '',
                'lieu_naissance' => mettre_en_majuscule($data['lieu_naissance'] ?? null) ?? '',
                'profession' => mettre_en_majuscule($data['profession'] ?? null) ?? '',
                ...
                'village' => mettre_en_majuscule($data['village'] ?? null) ?? '',
                'adresse_postale' => mettre_en_majuscule($data['adresse_postale'] ?? null) ?? '',
